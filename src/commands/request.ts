...
export const data =
  new SlashCommandBuilder()
    .setName('request')
    .setDescription(
      'Search for a movie or TV series to request.',
    )
    .setDescriptionLocalizations({
      fr:
        'Rechercher un film ou une série à demander.',
    })
    .addStringOption(
      option =>
        option
...
export async function execute(
  ...
  try {
    ...
    await interaction.editReply(
      '❌ Unable to search the request provider right now.',
    );
  }
}
