...
export const en = {
  ...
  commands: {
    ping: {
      description:
        'Check if MediaOps is online.',
    },

    health: {
      description:
        'Check MediaOps and Emby health.',
    },
  ...
  watchparty: {
    ...
    securityNotice:
      '🔐 Your Emby password is entered only on Watch Party and is never sent to {botName}.',
