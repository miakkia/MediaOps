...
MediaOps is currently in active development. Until the first stable public release, changes are grouped under **Unreleased** and summarized from merged feature work.
...
- Project roadmap covering multi-provider support, Docker distribution, and Unraid Community Apps.
- Architecture, product scope, provider model, security model, Discord feature, development, and vision documentation.
...
The current Unreleased work was built through the following merged milestones:
